...
loginForm.addEventListener("submit", async (e: SubmitEvent) => {
  ...
  // Hago un POST tipado al endpoint de creación de usuario
  // Envío un objeto que cumple con IUsuarioInputDTO
  const { data: usuario, error } = await Post<IUsuarioInputDTO, IUsuarioDTO>(
